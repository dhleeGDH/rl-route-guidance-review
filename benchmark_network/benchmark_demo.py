...
# A stranded node is charged the rest of its step budget at the minimum link cost, the
...
class GraphRouteEnv:
    ...
    def step(self, a):
        ...
        if self._t >= self.max_steps:
            ...
            # charged at the minimum link cost, which is what any vehicle that fails
...
def train_eval(net, boundary, reward, seed, episodes, eval_od, return_travel_time=False):
    ...
    # link cost of each trip, on the convention of Appendix E: the arriving move is the
