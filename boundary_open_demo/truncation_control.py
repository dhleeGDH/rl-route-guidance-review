...
Section V-A trains "with the step budget treated as a terminal", which is the practice [79]
documents as biasing a value function in a state that carries no time index. Under an
all-negative reward a timeout bootstrapped at zero is a value-0 absorbing option, which is an
alternative account of the boundary-open aligned cell's 35.1%.
