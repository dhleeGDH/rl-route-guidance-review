...
import optimal_vi_boundary_dest_gform2 as G                                  # noqa: E402
...
def main():
    ...
    json.dump(res, io.open(os.path.join(HERE, "grid_gform2.json"), "w", encoding="utf-8"), indent=1)
    print("\nwrote grid_gform2.json")
