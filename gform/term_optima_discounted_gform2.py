...
from optimal_vi_boundary_dest_gform2 import solve, arrives    # noqa: E402
...
def main():
    ...
    json.dump({"gammas": GAMMAS, "rows": out, "published": PUBLISHED,
               "moved_at_0.99": moved},
              io.open(os.path.join(HERE, "term_optima_discounted_gform2.json"), "w",
                      encoding="utf-8"), indent=1)
    print("\nwrote term_optima_discounted_gform2.json")
