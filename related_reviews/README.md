# Overlap of the reviewed studies with the ten prior reviews: attempted, NOT MEASURABLE from these PDFs

A survey reader wants one number first: of the 94 reviewed studies, how many does
...
meaningful. Each prior review's reference section is isolated, split into entries, and every reviewed
...
algorithm for maritime search and rescue", which is a different paper. **No reviewed study appears in
